...
```go
import "github.com/cdktf/cdktf-provider-googleworkspace-go/googleworkspace/v5/group"
...
&group.GroupConfig {
	...
	Description: *string,
	Name: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googleworkspace-go/googleworkspace/v5.group.GroupTimeouts,
}
```
