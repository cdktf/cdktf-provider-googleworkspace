...
```go
import "github.com/cdktf/cdktf-provider-googleworkspace-go/googleworkspace/v7/group"
...
&group.GroupConfig {
	...
	Description: *string,
	Name: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googleworkspace-go/googleworkspace/v7.group.GroupTimeouts,
}
```
