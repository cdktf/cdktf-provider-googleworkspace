...
```go
import "github.com/cdktf/cdktf-provider-googleworkspace-go/googleworkspace/v8/user"
...
&user.UserConfig {
	...
	Name: github.com/cdktf/cdktf-provider-googleworkspace-go/googleworkspace/v8.user.UserName,
	PrimaryEmail: *string,
	Addresses: interface{},
	Aliases: *[]*string,
	Archived: interface{},
	...
	Suspended: interface{},
	Timeouts: github.com/cdktf/cdktf-provider-googleworkspace-go/googleworkspace/v8.user.UserTimeouts,
	Websites: interface{},
}
```
