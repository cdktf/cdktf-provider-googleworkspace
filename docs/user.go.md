...
```go
import "github.com/cdktf/cdktf-provider-googleworkspace-go/googleworkspace/v3/user"
...
&user.UserConfig {
	...
	Name: github.com/cdktf/cdktf-provider-googleworkspace-go/googleworkspace/v3.user.UserName,
	PrimaryEmail: *string,
	Addresses: interface{},
	Aliases: *[]*string,
	Archived: interface{},
	...
	Suspended: interface{},
	Timeouts: github.com/cdktf/cdktf-provider-googleworkspace-go/googleworkspace/v3.user.UserTimeouts,
	Websites: interface{},
}
```
