...
```go
import "github.com/cdktf/cdktf-provider-googleworkspace-go/googleworkspace/v5/groupmember"
...
&groupmember.GroupMemberConfig {
	...
	Role: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googleworkspace-go/googleworkspace/v5.groupMember.GroupMemberTimeouts,
	Type: *string,
}
```
