...
```go
import "github.com/cdktf/cdktf-provider-googleworkspace-go/googleworkspace/v8/groupmember"
...
| <code><a href="#@cdktf/provider-googleworkspace.groupMember.GroupMember.toHclTerraform">ToHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-googleworkspace.groupMember.GroupMember.hasResourceMove">HasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-googleworkspace.groupMember.GroupMember.moveFromId">MoveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/provider-googleworkspace.groupMember.GroupMember.moveToId">MoveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `ToHclTerraform` <a name="ToHclTerraform" id="@cdktf/provider-googleworkspace.groupMember.GroupMember.toHclTerraform"></a>
...
##### `HasResourceMove` <a name="HasResourceMove" id="@cdktf/provider-googleworkspace.groupMember.GroupMember.hasResourceMove"></a>
...
##### `MoveFromId` <a name="MoveFromId" id="@cdktf/provider-googleworkspace.groupMember.GroupMember.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/provider-googleworkspace.groupMember.GroupMember.moveFromId.parameter.id"></a>
...
##### `MoveToId` <a name="MoveToId" id="@cdktf/provider-googleworkspace.groupMember.GroupMember.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/provider-googleworkspace.groupMember.GroupMember.moveToId.parameter.id"></a>
...
| <code><a href="#@cdktf/provider-googleworkspace.groupMember.GroupMember.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&groupmember.GroupMemberConfig {
	...
	Role: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googleworkspace-go/googleworkspace/v8.groupMember.GroupMemberTimeouts,
	Type: *string,
}
```
...
| <code><a href="#@cdktf/provider-googleworkspace.groupMember.GroupMemberConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
