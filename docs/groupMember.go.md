...
```go
import "github.com/cdktf/cdktf-provider-googleworkspace-go/googleworkspace/v7/groupmember"
...
&groupmember.GroupMemberConfig {
	...
	Role: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googleworkspace-go/googleworkspace/v7.groupMember.GroupMemberTimeouts,
	Type: *string,
}
```
