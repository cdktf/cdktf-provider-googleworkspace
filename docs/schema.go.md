...
```go
import "github.com/cdktf/cdktf-provider-googleworkspace-go/googleworkspace/v3/schema"
...
&schema.SchemaConfig {
	...
	SchemaName: *string,
	DisplayName: *string,
	Timeouts: github.com/cdktf/cdktf-provider-googleworkspace-go/googleworkspace/v3.schema.SchemaTimeouts,
}
```
...
&schema.SchemaFields {
	...
	NumericIndexingSpec: github.com/cdktf/cdktf-provider-googleworkspace-go/googleworkspace/v3.schema.SchemaFieldsNumericIndexingSpec,
