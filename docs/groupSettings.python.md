...
| <code><a href="#@cdktf/provider-googleworkspace.groupSettings.GroupSettings.toHclTerraform">to_hcl_terraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-googleworkspace.groupSettings.GroupSettings.hasResourceMove">has_resource_move</a></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-googleworkspace.groupSettings.GroupSettings.moveFromId">move_from_id</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/provider-googleworkspace.groupSettings.GroupSettings.moveToId">move_to_id</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `to_hcl_terraform` <a name="to_hcl_terraform" id="@cdktf/provider-googleworkspace.groupSettings.GroupSettings.toHclTerraform"></a>
...
##### `has_resource_move` <a name="has_resource_move" id="@cdktf/provider-googleworkspace.groupSettings.GroupSettings.hasResourceMove"></a>
...
##### `move_from_id` <a name="move_from_id" id="@cdktf/provider-googleworkspace.groupSettings.GroupSettings.moveFromId"></a>
...
##### `move_to_id` <a name="move_to_id" id="@cdktf/provider-googleworkspace.groupSettings.GroupSettings.moveToId"></a>
